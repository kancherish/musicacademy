...
function page() {
    return (
        <div className="">
            <div className="relative min-h-screen min-w-screen py-28 flex flex-col items-center gap-6">
                <h1 className="p-6 text-4xl">
                    CONTACT US
                </h1>
                <div className="w-[60vw]">
                    ...
                    <div className="">
                        ...
                        <textarea id="message" rows={4} className="h-[30vh] block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Write your queries here..."></textarea>
                    </div>
                    <div className="mt-10">
